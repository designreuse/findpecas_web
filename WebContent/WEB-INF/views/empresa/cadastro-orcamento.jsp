...
<head>
    ...
    <title>Find Pe�as | Novo Or�amento</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="layouts.html"><i class="fa fa-usd"></i> <span class="nav-label">Meus orçamentos</span></a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Avaliações</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <form method="get" class="form-horizontal">
								...
								<div class="hr-line-dashed"></div>
								<div class="form-group"><label class="col-sm-2 control-label">Ano do veículo</label>
								...
								<div class="hr-line-dashed"></div>
								<div class="form-group"><label class="col-sm-2 control-label">Observação</label>
								...
								<div class="hr-line-dashed"></div>
								<div class="form-group"><label class="col-sm-2 control-label">Usuário</label>
                        ...
                        <div class="ibox-content">
                            ...
                            <form method="get" class="form-horizontal">
                                <div class="form-group"><label class="col-sm-2 control-label">Descrição</label>
                                    <div class="col-sm-6">
										 <textarea class="form-control" id="message" rows="5" placeholder="Informe a descrição ..."></textarea>
        ...
        <div class="footer">
            ...
            <div>
                <strong>Copyright</strong> Find Peças &copy; 2015
            </div>
        </div>
