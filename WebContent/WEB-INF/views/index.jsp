            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="page-scroll" href="login">Logar</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div class="item active">
            <div class="container">
                ...
                <div class="carousel-image wow zoomIn">
                    <img src="<c:url value="/resources/img/landing/laptop.png"/>" alt="laptop"/>
                </div>
            </div>
...
<section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="<c:url value="/resources/img/landing/perspective.png"/>" alt="dashboard" class="img-responsive">
        </div>
    ...
    <div class="row features-block">
        ...
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="<c:url value="/resources/img/landing/dashboard.png"/>" alt="dashboard" class="img-responsive pull-right">
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="<c:url value="/resources/img/landing/avatar3.jpg"/>" class="img-responsive img-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="<c:url value="/resources/img/landing/avatar1.jpg"/>" class="img-responsive img-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="<c:url value="/resources/img/landing/avatar2.jpg"/>" class="img-responsive img-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="<c:url value="/resources/img/landing/iphone.jpg"/>" class="img-responsive" alt="dashboard">
            </div>
    ...
    <div class="container">
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <img alt="image" src="<c:url value="/resources/img/landing/avatar3.jpg"/>">
                    </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <img alt="image" src="<c:url value="/resources/img/landing/avatar1.jpg"/>">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <img alt="image" src="<c:url value="/resources/img/landing/avatar2.jpg"/>">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
